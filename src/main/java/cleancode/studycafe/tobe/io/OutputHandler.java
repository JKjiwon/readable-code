...
public class OutputHandler {
    ...
    public void showPassOrderSummary(StudyCafePassOrder studyCafePassOrder) {
        ...
        System.out.println("이용권: " + display(studyCafePassOrder.getStudyCafeSeatPass()));

        Optional<StudyCafeLockerPass> OptionalLockerPass = studyCafePassOrder.getStudyCafeLockerPass();
        OptionalLockerPass.ifPresent(lockerPass -> System.out.println("사물함: " + display(lockerPass)));
    ...
    private String display(StudyCafePass studyCafePass) {
