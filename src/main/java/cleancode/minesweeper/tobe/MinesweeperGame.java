...
// tip: 리펙토링 후 반드시 프로그램이 정상적으로 동작하는지 테스트를 해야한다.
// 테스트 코드를 통해 자동화 하는게 좋지만, 현재는 수동으로 테스트해보자.
...
public class MinesweeperGame {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            int selectedRowIndex = convertRowFrom(celInputRow);
    ...
    private static int convertRowFrom(char celInputRow) {
        return Character.getNumericValue(celInputRow) - 1;
    }
